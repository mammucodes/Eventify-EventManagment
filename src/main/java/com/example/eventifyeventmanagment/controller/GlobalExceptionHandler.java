...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleGeneralException(Exception ex) {
        logger.error("Unexpected error occurred test: {} {}",ex.getClass().getName(),  ex.getMessage());
...
@ExceptionHandler(NoOfSeatsToBookNotFoundException.class)
    public ResponseEntity<ErrorResponse> handleNoOfSeatsToBookNotFoundException(NoOfSeatsToBookNotFoundException stb) {
        logger.error("no of seats to be booke should pass");
        return ResponseEntity.badRequest().body(new ErrorResponse("need to pass no of seats to be booked", "400"));
    }
 }
